...
redirect ${out_path}/${TOP_MODULE}_critical_path_300k_nowire {report_timing -through [get_pins -of_objects {*}] -through [get_pins -of_objects {  UUT5_0*}]}
redirect ${out_path}/${TOP_MODULE}_power_300k_nowire                   {report_power -hierarchy -levels 10}
