...
redirect ${out_path}/${TOP_MODULE}_critical_path_77k_nowire {report_timing -through [get_pins -of_objects {  UUT1*}] -through [get_pins -of_objects {  UUT5_1*}]}
redirect ${out_path}/${TOP_MODULE}_power_77k_nowire                   {report_power -hierarchy -levels 10}
